...
if (typeof window !== 'undefined') {
  ...
  window.Polaris.VERSION = '3.14.0';
}

var polarisVersion = '3.14.0';
...
function (_React$PureComponent) {
  ...
  function PopoverOverlay() {
    ...
    _this.renderPopover = function (transitionStatus, overlayDetails) {
      ...
      var className = styles$1A.classNames(styles$j.Popover, transitionStatus && animationVariations(transitionStatus), positioning === 'above' && styles$j.positionedAbove, fullWidth && styles$j.fullWidth, measuring && styles$j.measuring);
...
function (_React$PureComponent) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var inputClassName = styles$1A.classNames(styles$p.Input, suffix && styles$p['Input-suffixed']);
...
function (_React$PureComponent) {
  ...
  _createClass(Checkbox, [{
    ...
    value: function componentDidUpdate(_ref) {
      ...
      if (this.props.disabled && !prevDisabled !== true && this.inputNode.current && this.inputNode.current.checked) {
        this.handleInput();
      }
    }
  }, {
    ...
    value: function render() {
      var _this$props3 = this.props,
          ...
          id = _this$props3$id === void 0 ? getUniqueID$4() : _this$props3$id,
          label = _this$props3.label,
          labelHidden = _this$props3.labelHidden,
          helpText = _this$props3.helpText,
          _this$props3$checked = _this$props3.checked,
          checked = _this$props3$checked === void 0 ? false : _this$props3$checked,
