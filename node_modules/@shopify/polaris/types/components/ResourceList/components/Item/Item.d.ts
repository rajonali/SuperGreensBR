...
export declare class Item extends React.Component<CombinedProps, State> {
...
declare const _default: (React.ComponentClass<Props, any> & Pick<(React.ComponentClass<CombinedProps, any> & typeof Item) | (React.FunctionComponent<CombinedProps> & typeof Item), "defaultProps" | "prototype">) | (React.FunctionComponent<Props> & Pick<(React.ComponentClass<CombinedProps, any> & typeof Item) | (React.FunctionComponent<CombinedProps> & typeof Item), "defaultProps" | "prototype">);
